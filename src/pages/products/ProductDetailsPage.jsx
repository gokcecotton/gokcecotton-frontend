...
export const ProductDetailsPage = () => {
    ...
    useEffect(() => {
        ...
        // Backend attributes are stored in a Map. In JS, they might come as an object.
        if (product?.attributes) {
            // Initialize with first values if possible or leave empty
            const initial = {};
            Object.entries(product.attributes).forEach(([key, value]) => {
                // If value is a string of comma separated options like "Red, Blue, Green"
